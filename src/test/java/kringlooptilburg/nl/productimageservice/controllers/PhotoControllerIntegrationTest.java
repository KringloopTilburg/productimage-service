...
public class PhotoControllerIntegrationTest {
    ...
    @Autowired
    public PhotoControllerIntegrationTest(MockMvc mockMvc, ObjectMapper objectMapper, PhotoController photoController) {
...
//
//        mockMvc.perform(MockMvcRequestBuilders.get("/productimage-service")
